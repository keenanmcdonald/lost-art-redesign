...
export const albumData = [
  ...
  },
  {
    ...
    cover: "cody.jpg",
    description: [
      "Cody Hubach was the real deal. The re-release of Cody’s 1999 recording, I Got The Blues, reveals the power and talent of one of Austin’s revered renegade songwriters. A gifted singer, songwriter and talented guitarist, Cody captivated audiences with heartfelt honesty. Long before “Americana” became a musical genre, Cody’s music intermingled the roots of country, folk and blues.",
      "From the mid-60’s through the 90’s Cody regularly occupied the stages of the honkytonks and clubs at the heart of Austin’s music scene and throughout Central Texas. Cody held court at iconic venues including Threadgills, the Austin Outhouse, Spellmans, the Split Rail, the One Knight, Checkered Flag, AusTex Lounge, Giddy Ups and many more. His circle of outlaw compadres was filled by Blaze Foley, Jubal Clark and Calvin Russell.",
      "The tracks here were recorded in 1999 in Driftwood, Texas by John Casner shortly after Cody was diagnosed with cancer. They never benefited from wide distribution. Lost Art Records is excited to share this chapter of Austin’s musical legacy and proud to showcase the power, spirit and honesty of Cody Hubach.",
    ],
    notes: [
      "Personnel:",
      "Cody Hubach, Vocals, Guitar",
      "John Meadows, Banjo, Vocals",
      "Boomer Norman, Guitar",
      "Dave Kembro, Bass",
      "Lost John Casner, Keyboards",
      "Recorded & Mixed by: John Casner, Sum Studios, Driftwood, Texas 1999",
    ],
    links: [
      { text: "More about 'I Got The Blues", href: "/cody-onesheet.pdf" },
      { text: "Cody Hubach: The Real Deal", href: "/cody-bio.pdf" },
      { text: "Video: Skid Row Rodeo", href: "https://youtu.be/zqO9BImCyMU" },
      {
        text: "Video: Livin’ With The Animals",
        href: "https://youtu.be/KNLlPp37he4",
      },
      { text: "Video: Black Cat Blues", href: "https://youtu.be/Z8ha3Nd_n3E" },
      { text: "Video: I Got The Blues", href: "https://youtu.be/Gy16hNDKErk" },
    ],
    purchase: [
      {
        format: "CD",
        price: "$12.99",
        button_id: "6WQRQEG2SZ52G",
      },
    ],
    path: "igottheblues",
    code: "",
  ...
  },
  {
    ...
    notes:
      "Musicians: Blaze Foley, Gurf Morlix, Jimmy Don Smith, Tony Braunagel, John Hill, Riley Osbourn, Ed Bradfield, Sarah Elizabeth Campbell, Lost John Casner, Champ Hood, David Waddell.",
    quote:
      '"Blaze is one of the most spiritual cats I’ve ever met; an ace finger picker; a writer who never shirks the truth and never fails to rhyme,"',
    quote_attribution: "– Townes Van Zandt.",
    purchase: [
      {
        format: "Vinyl",
        price: "$18.00",
  ...
  },
  {
    ...
    artist: "Blaze Foley",
    cover: "sittin-by-the-road-cover.jpg",
    description: [
    ...
    purchase: [
      {
        format: "CD",
        price: "$15.99",
        button_id: "L5C9B5P4ZTZHN",
        disabled: true,
      },
    ],
    message: "Temporarily out of stock",
    path: "ovalroom",
    spotify: "5UklcnwePgX8gDrOMTO4qS",
    code: "LAR 1018",
  },
  {
    title: "Duct Tape Messiah",
    artist: "Blaze Foley",
    cover: "duct-tape-messiah-cover.jpg",
    description: [
  ...
  },
  {
    ...
    artist: "Bill Neely",
    cover: "bill-neely-cover.jpg",
    description: [
      "Austin is known as the breeding ground for a rich legacy of country and blues singer-songwriters. Bill Neely was Austin’s first. Bill Neely bridged the origins of country blues and the modern Texas singer/songwriter tradition. His talent as a writer and singer of Texas country and blues makes him a true Texas music treasure.",
    ],
    notes:
  ...
  },
  {
    ...
    artist: "",
    cover: "duct-tape-deluxe-cover.jpg",
    tall: true,
    description: [
    ...
    purchase: [
      {
        format: "DVD",
        price: "$18.00",
        button_id: "QAGSMPA63SQDJ",
      },
    ],
    path: "ducttapedoc",
    video:
      '<iframe class=\'album-page-video\' title=\'duct-tape-messiah-trailer\' src="https://www.youtube.com/embed/tz2kULLO0Sc" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>',
    code: "LAR/ABP 1002",
  },
]
